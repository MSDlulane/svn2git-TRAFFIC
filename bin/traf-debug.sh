...
cd "$TRAFDIR"
exec -a "$TRAFPROCNAME" java -server $TRAFMEMSETTINGS $TRAFSNMPSETTINGS $TRAFJMXSETTINGS -jar "$TRAFHOME/lib/$TRAFLIB/TRAF.jar" "$TRAFDIR/config.xml" >"$TRAFDIR/log/stdout" 2>"$TRAFDIR/log/stderr" &
