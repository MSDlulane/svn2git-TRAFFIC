DELETE FROM SCHEME_XREF WHERE id='J'
GO
DELETE FROM USER_SCHEME WHERE SCHEME_ID=(SELECT SCHEME_ID FROM SCHEME_INFO WHERE Z_SUPER_SCHEME LIKE 'J '
GO
DELETE FROM SCHEME_INFO WHERE SCHEME_ID = 'J'
GO
